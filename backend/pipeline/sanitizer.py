...
GENERAL_REPLACEMENTS: list[tuple[re.Pattern, str]] = [
    ...
    (re.compile(r"(?i)\batracadores\s+encapuchad[oa]s\b"), "actores encapuchados"),
    (re.compile(r"(?i)\batracador\s+encapuchad[oa]\b"), "actor encapuchado"),
    (re.compile(r"(?i)\batracadores\b"), "actores encapuchados"),
    (re.compile(r"(?i)\batracador\b"), "actor encapuchado"),
